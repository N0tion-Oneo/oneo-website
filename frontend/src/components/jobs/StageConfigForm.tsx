        ...
        <div className="p-4 space-y-4">
          ...
          {config.requiresLocation && (
            <div className="space-y-3">
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                />
                <span className="text-sm text-gray-700">Use company address</span>
              </label>
          ...
          {config.isAssessment && (
            <div className="space-y-4 p-4 bg-orange-50 rounded-lg">
              <h4 className="text-sm font-medium text-orange-800">Assessment Settings</h4>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-3 py-2 border border-gray-200 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent resize-none bg-white"
                />
              </div>
