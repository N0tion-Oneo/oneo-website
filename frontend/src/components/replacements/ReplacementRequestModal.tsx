          ...
          <div className="p-6">
            {isCheckingEligibility ? (
              <div className="flex items-center justify-center py-8">
                ...
                <span className="ml-3 text-[14px] text-gray-500">Checking eligibility...</span>
              </div>
                ...
                {eligibility.replacement_period_days > 0 && (
                  <div className="p-4 bg-gray-50 border border-gray-200 rounded-lg space-y-3">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[13px] font-medium text-gray-700">Replacement Period Info</span>
                    </div>
                    <div className="grid grid-cols-2 gap-4 text-[13px]">
                      <div>
                        <p className="text-gray-500">Period Length</p>
                        <p className="text-gray-900 font-medium">{eligibility.replacement_period_days} days</p>
                      </div>
                      {eligibility.start_date && (
                        <div>
                          <p className="text-gray-500">Start Date</p>
                          <p className="text-gray-900 font-medium">{formatDate(eligibility.start_date)}</p>
                        </div>
                      )}
                      {eligibility.expiry_date && (
                        <div>
                          <p className="text-gray-500">Expiry Date</p>
                          <p className="text-gray-900 font-medium">{formatDate(eligibility.expiry_date)}</p>
                        </div>
                      )}
                    </div>
                  </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                {/* Period Info */}
                <div className="grid grid-cols-2 gap-4 p-4 bg-gray-50 border border-gray-200 rounded-lg text-[13px]">
                  <div>
