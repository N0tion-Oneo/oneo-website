    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <h4 className="text-[13px] font-medium text-gray-900 line-clamp-1 group-hover:text-gray-700">
            {post.job.title}
          </h4>
          <p className="text-[12px] text-gray-500 mt-0.5">{post.company?.name}</p>
          ...
          <p className="text-[10px] text-gray-400 mt-1.5">{timeAgo}</p>
        </div>
      </div>
    </Link>
  )
    ...
    <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-[14px] font-semibold text-gray-900">Latest Jobs</h2>
        </div>
        <Link
          to="/jobs"
      ...
      {isLoading ? (
        ...
        <div className="py-8 text-center">
          ...
          <p className="text-[13px] text-gray-500">No jobs posted yet</p>
        </div>
      ) : (
