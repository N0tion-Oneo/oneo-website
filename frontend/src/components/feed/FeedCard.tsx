  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
      ...
      {featuredImage && isArticle && (
        <div className="aspect-[2.5/1] relative overflow-hidden bg-gray-100">
          <img
            src={featuredImage}
      ...
      <div className="p-4">
        ...
        <div className="flex items-center gap-2.5 mb-2.5">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2">
              <span className="text-[13px] font-medium text-gray-900">{post.company?.name}</span>
              <span className="text-[11px] text-gray-400">·</span>
              <span className="text-[11px] text-gray-400">{timeAgo}</span>
            </div>
            <span className={`text-[11px] font-medium ${isArticle ? 'text-blue-600' : 'text-emerald-600'}`}>
        ...
        <div>
          {/* Title */}
          {post.title && (
            <h3 className="text-[15px] font-semibold text-gray-900 mb-1.5 line-clamp-2">
              {post.title}
            </h3>
          )}
