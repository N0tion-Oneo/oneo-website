...
export default function NotificationsDrawer({
  ...
  return createPortal(
    <>
      {/* Backdrop */}
      <div
        className={`fixed inset-y-0 right-0 ${sidebarOffset} bg-black/30 dark:bg-black/50 z-[200] transition-opacity`}
        onClick={onClose}
      />

      {/* Drawer */}
      <div className={`fixed inset-y-0 ${sidebarOffset} ${drawerWidth} bg-white dark:bg-gray-900 shadow-xl dark:shadow-gray-900/50 z-[201] flex flex-col border-r border-gray-200 dark:border-gray-700`}>
        {/* Header */}
        <div className="flex items-center justify-between px-6 h-14 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
          <div className="flex items-center gap-3">
            <Bell className="w-5 h-5 text-gray-600 dark:text-gray-400" />
            <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Notifications</h2>
            {unreadCount > 0 && (
              <span className="px-2 py-0.5 text-xs font-medium text-blue-700 bg-blue-100 dark:bg-blue-900/30 rounded-full">
                {unreadCount} unread
              </span>
            )}
          </div>
        ...
        <div className="flex-1 overflow-y-auto">
          {isLoading && notifications.length === 0 ? (
            ...
            <div className="flex flex-col items-center justify-center py-16 text-gray-500">
              ...
              <p className="text-lg font-medium text-gray-500 dark:text-gray-400">No notifications yet</p>
            ...
            <div className="divide-y divide-gray-100 dark:divide-gray-800">
              {notifications.map((notification) => (
                <div
                  ...
                  className={`px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all ${
                      ...
                      <div className="flex items-start justify-between gap-2">
                        ...
                        {!notification.is_read && (
                          <button
                            ...
                            className="flex-shrink-0 p-1 text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 rounded hover:bg-gray-200 dark:hover:bg-gray-700"
                            title="Mark as read"
                          >
