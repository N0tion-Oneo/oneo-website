  ...
  const renderQuestionInput = (question: ApplicationQuestion) => {
    ...
    switch (question.question_type) {
      case QuestionType.TEXT:
        return (
          <input
            ...
            className="w-full px-3 py-2 border border-gray-200 dark:border-gray-700 rounded-md text-[14px] text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-100 focus:border-transparent"
          />
        )
      ...
      case QuestionType.SELECT:
        return (
          <select
            value={value}
            onChange={(e) => handleAnswerChange(question.id, e.target.value)}
            className="w-full px-3 py-2 border border-gray-200 dark:border-gray-700 rounded-md text-[14px] text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-100 focus:border-transparent"
          >
          ...
          <div className="space-y-2">
            {question.options.map((option, idx) => (
              <label key={idx} className="flex items-center gap-2 cursor-pointer">
                ...
                />
                <span className="text-[14px] text-gray-700 dark:text-gray-300">{option}</span>
              </label>
            ))}
          </div>
        )
      ...
      case QuestionType.FILE:
        return (
          <div className="border border-dashed border-gray-300 dark:border-gray-600 rounded-md p-4 text-center bg-white dark:bg-gray-800">
        ...
        return (
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              className="flex-1 px-3 py-2 border border-gray-200 dark:border-gray-700 rounded-md text-[14px] text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-100 focus:border-transparent"
            />
          </div>
        )
        ...
        <div className="px-6 py-4 overflow-y-auto flex-1">
          {success ? (
            <div className="text-center py-8">
              ...
              <button
                onClick={handleClose}
                className="px-4 py-2 text-[14px] font-medium text-white bg-gray-900 dark:bg-gray-100 dark:text-gray-900 rounded-md hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors"
              >
                Done
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="mb-4 p-3 bg-gray-50 dark:bg-gray-800 rounded-md">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {job.interview_stages.map((stage, index) => (
                      <span
                        key={index}
                        className="inline-flex items-center px-2 py-1 text-xs font-medium text-gray-600 dark:text-gray-400 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-md"
                      >
              ...
              <div className="flex justify-end gap-3 pt-4 border-t border-gray-100 dark:border-gray-800">
                <button
                  ...
                  onClick={handleClose}
                  disabled={isLoading}
                  className="px-4 py-2 text-[14px] font-medium text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-700 rounded-md hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  disabled={isLoading}
                  className="inline-flex items-center gap-2 px-4 py-2 text-[14px] font-medium text-white bg-gray-900 dark:bg-gray-100 dark:text-gray-900 rounded-md hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
