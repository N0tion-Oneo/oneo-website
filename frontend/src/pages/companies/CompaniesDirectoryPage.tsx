  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <main className="max-w-5xl mx-auto px-6 py-10">
        {/* Page Header */}
        <div className="mb-8">
          <h1 className="text-[26px] font-semibold text-gray-900 dark:text-gray-100">Company Directory</h1>
          ...
          <div className="grid md:grid-cols-4 gap-4">
            ...
            <div className="flex items-end">
              <button
                ...
                className="w-full px-4 py-2 text-[13px] font-medium text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-700 rounded-md hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
              >
                Clear Filters
              </button>
            </div>
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {company.tagline && (
                      <p className="text-[13px] text-gray-500 dark:text-gray-400 truncate mt-0.5">{company.tagline}</p>
                    )}
                    {company.industry && (
                      <p className="text-[12px] text-gray-400 dark:text-gray-500 mt-1">{company.industry.name}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  {company.funding_stage && (
                    <span className="px-2 py-0.5 text-[11px] font-medium bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-400 rounded">
                      {getFundingStageLabel(company.funding_stage)}
                    </span>
                  )}
                  {company.tech_stack && company.tech_stack.length > 0 && (
                    <span className="px-2 py-0.5 text-[11px] font-medium bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 rounded">
