        ...
        <div className="max-w-5xl mx-auto px-6 py-12">
            ...
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <div className="flex gap-2 flex-wrap">
                <select
                  ...
                  className="px-4 py-2.5 text-[14px] bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-100 focus:border-emerald-300 transition-all cursor-pointer"
                >
          ...
          {!isLoading && filteredStudies.length === 0 && (
            <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
              ...
              <h3 className="text-[18px] font-semibold text-gray-900 mb-2">No case studies found</h3>
                ...
                <div className="grid md:grid-cols-2 gap-0">
                  ...
                  <div className="p-8 md:p-10 flex flex-col justify-center">
                    ...
                    {featuredStudy.client_name && (
                      <p className="text-[13px] font-medium text-gray-500 mb-2 flex items-center gap-1.5">
    ...
    >
      ...
      <div className="p-5">
        ...
        <div className="flex items-center justify-between text-[12px] text-gray-400">
          ...
          <span className="inline-flex items-center gap-1 text-[13px] font-medium text-emerald-600 group-hover:gap-2 transition-all">
            Read more
