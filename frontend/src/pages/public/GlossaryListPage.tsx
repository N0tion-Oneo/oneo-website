      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-5xl mx-auto px-6 py-16 md:py-20">
          <div className="max-w-2xl">
            <span className="inline-flex items-center gap-2 px-3 py-1 bg-emerald-50 text-emerald-600 text-[12px] font-medium rounded-full mb-4">
        ...
        <div className="max-w-5xl mx-auto px-6 py-12">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-4 mb-8 shadow-sm">
            ...
            <div className="relative mb-4">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 text-[14px] bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-100 focus:border-emerald-300 transition-all"
              />
            </div>
          ...
          {!isLoading && filteredTerms.length === 0 && (
            <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
              ...
              <h3 className="text-[18px] font-semibold text-gray-900 mb-2">No terms found</h3>
                ...
                <div key={letter} id={`letter-${letter}`}>
                  ...
                  <div className="sticky top-0 z-10 bg-gray-50 py-2">
                    <div className="flex items-center gap-3">
                      <span className="w-10 h-10 flex items-center justify-center bg-emerald-100 text-emerald-700 text-[18px] font-bold rounded-lg">
                        {letter}
                      </span>
                  ...
                  <div className="mt-4 grid gap-3">
                    {letterTerms.map((term) => (
                      <Link
                        ...
                        className="group bg-white rounded-lg border border-gray-200 p-4 hover:border-emerald-200 hover:shadow-sm transition-all"
                      >
                        <div className="flex items-start justify-between gap-4">
                          <div className="flex-1 min-w-0">
                            <h3 className="text-[16px] font-semibold text-gray-900 group-hover:text-emerald-700 transition-colors">
                              {term.title}
                            </h3>
                          ...
                          <ArrowRight className="w-5 h-5 text-gray-300 group-hover:text-emerald-500 group-hover:translate-x-1 transition-all flex-shrink-0 mt-0.5" />
                        </div>
                      </Link>
                    ))}
                  </div>
          ...
          {!isLoading && groupedTerms.length > 3 && (
            <div className="fixed bottom-6 right-6 bg-white rounded-lg border border-gray-200 shadow-lg p-2 hidden lg:block">
              <div className="flex flex-col gap-1">
                {groupedTerms.map(([letter]) => (
                  <a
                    key={letter}
                    href={`#letter-${letter}`}
                    className="w-7 h-7 flex items-center justify-center text-[12px] font-medium text-gray-500 hover:bg-emerald-50 hover:text-emerald-600 rounded transition-colors"
                  >
                    {letter}
                  </a>
                ))}
