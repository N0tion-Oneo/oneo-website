      ...
      <div className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
        <div className="max-w-5xl mx-auto px-6 py-16 md:py-20">
          <div className="max-w-2xl">
            <span className="inline-flex items-center gap-2 px-3 py-1 bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 text-[12px] font-medium rounded-full mb-4">
      ...
      <div className="flex-1">
        <div className="max-w-5xl mx-auto px-6 py-12">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4 mb-8 shadow-sm dark:shadow-gray-900/40">
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 text-[14px] bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-100 dark:focus:ring-blue-900 focus:border-blue-300 dark:focus:border-blue-600 transition-all text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400"
                />
              </div>
              ...
              <div className="flex gap-2 flex-wrap">
                <select
                  ...
                  className="px-4 py-2.5 text-[14px] bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-100 dark:focus:ring-blue-900 focus:border-blue-300 dark:focus:border-blue-600 transition-all cursor-pointer text-gray-900 dark:text-gray-100"
                >
            ...
            {/* Tags */}
            {allTags.length > 0 && (
              <div className="flex items-center gap-2 mt-4 pt-4 border-t border-gray-100 dark:border-gray-700 flex-wrap">
                <span className="text-[12px] text-gray-500 dark:text-gray-400 font-medium">Popular tags:</span>
          ...
          {!isLoading && filteredPosts.length === 0 && (
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-12 text-center">
              ...
              <h3 className="text-[18px] font-semibold text-gray-900 dark:text-gray-100 mb-2">No articles found</h3>
                  ...
                  <div className="p-8 md:p-10 flex flex-col justify-center">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      {featuredPost.category && (
                        <span className="text-[12px] font-medium text-blue-600 dark:text-blue-400 uppercase tracking-wider">
                          {featuredPost.category}
                        </span>
                      )}
                    </div>
