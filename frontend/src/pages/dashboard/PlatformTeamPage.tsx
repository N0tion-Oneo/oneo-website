      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-8">
          <div className="text-center">
            ...
            <h3 className="text-[16px] font-medium text-gray-900 mb-2">No Platform Company</h3>
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gray-50 rounded-lg border border-gray-200 px-4 py-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-[14px] font-medium text-gray-900">{platformCompany.name}</p>
            <p className="text-[12px] text-gray-500">Platform Company</p>
          </div>
        </div>
      </div>
