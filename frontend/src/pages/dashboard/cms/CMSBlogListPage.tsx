  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-[20px] font-semibold text-gray-900 dark:text-gray-100">Blog Posts</h1>
      ...
      {isLoading && (
        <div className="text-center py-12">
          <p className="text-[14px] text-gray-500 dark:text-gray-400">Loading posts...</p>
        </div>
      )}
      ...
      {error && (
        <div className="text-center py-12">
          <p className="text-[14px] text-red-500 dark:text-red-400">Failed to load posts</p>
        </div>
      )}
      ...
      {!isLoading && !error && filteredPosts.length === 0 && (
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-8 text-center">
          ...
          <p className="text-[15px] text-gray-700 dark:text-gray-300 mb-1">No blog posts found</p>
              ...
              <div className="p-4">
                ...
                <div className="flex items-center gap-2 pt-3 border-t border-gray-100 dark:border-gray-800">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 px-3 py-1.5 text-[12px] text-red-500 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/30 rounded-md transition-colors ml-auto"
                  >
