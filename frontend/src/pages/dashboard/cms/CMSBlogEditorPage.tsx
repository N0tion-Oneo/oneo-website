...
export default function CMSBlogEditorPage() {
  ...
  if (!isNew && postError) {
    return (
      <div className="bg-white border border-gray-200 rounded-lg p-8 text-center">
        <AlertCircle className="w-12 h-12 text-red-300 mx-auto mb-4" />
        <p className="text-[15px] text-gray-700 mb-2">Blog post not found</p>
        <Link
        ...
        {showSettings && (
          <div className="w-80 flex-shrink-0">
            <div className="bg-white border border-gray-200 rounded-lg p-4 sticky top-20">
              <h3 className="text-[14px] font-medium text-gray-900 mb-4">Post Settings</h3>
              ...
              <div className="mb-4">
                ...
                <div className="flex items-center">
                  <span className="text-[12px] text-gray-500 mr-1">/blog/</span>
                  <input
                    type="text"
                    value={formData.slug}
              ...
              <div className="mb-4">
                ...
                <div className="flex gap-1">
                  ...
                  <button
                    ...
                    className="px-2 py-1.5 text-gray-500 hover:text-gray-700 border border-gray-200 rounded-md"
                  >
